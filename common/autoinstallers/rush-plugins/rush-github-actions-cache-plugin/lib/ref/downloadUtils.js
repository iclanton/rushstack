 ...
 */
async function downloadCacheHttpClient(archiveLocation, onChunk, getWrittenLength) {
    ...
    const responseBuffer = await downloadResponse.readBodyBuffer();
 ...
 * @param archivePath the local path where the cache is saved
 */
async function downloadCacheHttpClientConcurrent(archiveLocation, onChunk, options) {
    var _a;
 ...
 */
async function downloadCacheStorageSDK(archiveLocation, onChunk, getWrittenLength, options) {
    var _a;
